...
users = {
    os.getenv('LABUSER'): os.getenv('LABPASSWD')
}
...
def new_droplet(account, pubssh, distro):
    ...
    keys = [userkey, admkey]
    vm = droplet.digitalocean.Droplet(token=TOKEN,
